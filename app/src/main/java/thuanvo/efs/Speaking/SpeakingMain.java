package thuanvo.efs.Speaking;//***insert your package here***
 ...
 * - when user selects a speaking_word from the list, the app speaks the speaking_word back using the TTS engine
 */
public class SpeakingMain extends Activity implements OnClickListener, OnInitListener {
	...
	private final String LOG_TAG = "SpeakingMain";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //gain reference to speaking_word list
        ...
        wordList.setOnItemClickListener(new OnItemClickListener() {
        	...
        	public void onItemClick(AdapterView<?> parent, View view, int position, long id) 
            {
            	...
            	//retrieve the chosen speaking_word
            	String wordChosen = (String) wordView.getText();
            	//output for debugging
            	Log.v(LOG_TAG, "chosen: "+wordChosen);
            	//speak the speaking_word using the TTS
            	repeatTTS.speak(""+wordChosen, TextToSpeech.QUEUE_FLUSH, null);
            	//output Toast message
            	//Toast.makeText(SpeakingMain.this, "You said: "+wordChosen, Toast.LENGTH_SHORT).show();//**alter for your Activity name***
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        {
        	//store the returned speaking_word list as an ArrayList
            ArrayList<String> suggestedWords = data.getStringArrayListExtra(RecognizerIntent.EXTRA_RESULTS);
            //set the retrieved list to display in the ListView using an ArrayAdapter
            wordList.setAdapter(new ArrayAdapter<String> (this, R.layout.speaking_word, suggestedWords));
        }
